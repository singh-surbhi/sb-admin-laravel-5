...
@section('content')
 ...
 <section class="tech">
        <div class="image-wrap" style="position: relative;">
            <img src="images/nodebanner2.png" alt="" class="img-responsive header-img" style="width: 100%; height: 100%; ">
            <div class="over-lay">
                <div class="container">
                    <div class="row">
                        <div class="wrapper-header">
                            <h2 class="servicepage-heading text-center">Node</h2>
                            <div class="col-md-12">
    ...
    <section class="project-bio" id="about-react">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="pro-about-heading text-center">Node Js<hr></p>
                </div>
