...
@section('content')
   ...
   <!-- ===================== header ==================== -->
                    ...
                    <div class="header">
                        <div class="header-text">
                            ...
                            <a href="http://startlaravel.com/" target="_blank" class="start-laravel"> StartLaravel</a></p> 
                           	<a href="/contact" target="_blank" class="page-scroll btn btn-xl hidden-xs">Start Project</a> 
                            <div class="col-md-12 col-sm-12 page-scroll hidden-xs">
                                <a href="#overview" class="page-scroll hvr-icon-hang icon-hang"></a></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- ======================== start project ================ -->
    <section class="quotes" id="Technologies">
        <div class="container-fluid">
            <div class="row text-center">
                ...
                <div class="col-md-3 tech-column ">
                    <div class="grid">
                        <figure>
                            ...
                            <h2 class="angular-heading">Node Js</h2>
                            <figcaption>
                                <h4 class="slide-project">Number Of Projects: 255</h4>
                                <h4 class="slide-project">Sailor For Angular: 50+</h4>
                                <a href="http://startangular.com/">Take a look</a>
                ...
                <div class="col-md-3 tech-column ">
                    ...
                    <div class="grid">
                        <figure>
                            ...
                            <h2 class="angular-heading">React Native</h2>
                            <figcaption>
                                <h4 class="slide-project">Number Of Projects: 255</h4>
                                <h4 class="slide-project">Sailor For Angular: 50+</h4>
                                <a href="http://startangular.com/">Take a look</a>
                 ...
                 <div class="col-md-3 tech-column ">
                    ...
                    <div class="grid">
                        <figure>
                            ...
                            <h2 class="angular-heading">Laravel</h2>
                            <figcaption>
                                <h4 class="slide-project">Number Of Projects: 255</h4>
                                <h4 class="slide-project">Sailor For Angular: 50+</h4>
                                <a href="http://startangular.com/">Take a look</a>
