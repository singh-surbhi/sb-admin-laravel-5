...
@section('content')
    ...
    <div class="container open-overlay">
        <div class="row text-center">
            <h1 class="text-center open-source-head">Open Source Contribution</h2><hr></h1>
        </div>

        <!-- <div class="col-md-12 col-sm-12 page-scroll hidden-xs text-center">
            <a href="#git-hub" class="page-scroll hvr-icon-hang icon-hang"></a>
        </div> -->
    </div>
    <!-- ===================== open source ================= -->
