            ...
            <div class="container">
                <div class="row">
                    <div class="wrapper-header">
                        <h2 class="servicepage-heading text-center">What We Do</h2>
                        <div class="col-md-12">
                            <p class="servicepage-desc">Collaborative Work. Agile Process. Ongoing Support.</p>
                        </div>
                        <div class="col-md-12 col-sm-12 page-scroll hidden-xs"><a class="page-scroll" href="#things"><img src="images/arrows.png" alt="scroll down" class="img-responsive center-block img-scroll"></a></div>
                    </div>
                </div>
            </div>
        </div>  
